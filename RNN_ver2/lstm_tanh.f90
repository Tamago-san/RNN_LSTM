subroutine lstm_traning_own_fortran(in_node,out_node,rnn_node,traning_step,rnn_step,&
    ...
    do iepo=1,epoch
        ...
        if(mod(iepo,200)==0) write(*,*) "epoch      === " ,iepo
        if(mod(iepo,200)==0) write(*,*) "loss       === " ,loss
        if(mod(iepo,200)==0) write(*,*) "iepsi      === " ,iepsi
        ...
        do isample=1,sample_num
            ...
            if(loss>1.d0) then
                iepsi=1.d-4
            else if(loss<1.d0 .and. loss>1.d-1) then
                iepsi=1.d-4
            else if(loss<1.d-1 .and. loss>1.d-2) then
                iepsi=1.d-4
            else if(loss<1.d-2 ) then
                iepsi=1.d-4
            endif
            if(iepo>50000) then
                iepsi=1.d-4
